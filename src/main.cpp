...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "eqqgqgqgfdfdf ok man 2016";
        CTransaction txNew;
        txNew.nTime = 1525786197;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525786197;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2077980 : 2077980;
        ...
        assert(block.hashMerkleRoot == uint256("0x5fa2769f778b82bc73a3eec77eb589420194dd416e87f73bad1767eaa94356da"));
...
unsigned char pchMessageStart[4] = { 0x11, 0x4e, 0x66, 0x34 };
